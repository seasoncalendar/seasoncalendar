    ...
    return Scaffold(
        ...
        body: Container(
            ...
            child: SingleChildScrollView(
                child: Column(
              children: <Widget>[
                Text(L10n.of(context).aboutPageExplanationHeadline,
                    style: defaultTheme.textTheme.headline4),
                SizedBox(height: 20),
                Text(L10n.of(context).aboutPageExplanation,
                ...
                ListTile(
                  ...
                  title: Text(L10n.of(context).aboutPageAvLocal,
                      style: defaultTheme.textTheme.bodyText1),
                ),
                ListTile(
                  dense: true,
                  leading: Icon(Icons.local_shipping, color: Colors.black),
                  title: Text(L10n.of(context).aboutPageAvLand,
                      style: defaultTheme.textTheme.bodyText1),
                ),
                ListTile(
                  dense: true,
                  leading: Icon(Icons.directions_boat, color: Colors.black),
                  title: Text(L10n.of(context).aboutPageAvSea,
                      style: defaultTheme.textTheme.bodyText1),
                ),
                ListTile(
                  dense: true,
                  leading: Icon(Icons.airplanemode_active, color: Colors.black),
                  title: Text(L10n.of(context).aboutPageAvAir,
                      style: defaultTheme.textTheme.bodyText1),
                ),
                SizedBox(height: 10),
                Text(L10n.of(context).aboutPageColors,
                    style: defaultTheme.textTheme.bodyText1,
                    textAlign: TextAlign.justify),
                SizedBox(height: 10),
                Text(L10n.of(context).aboutPageFavorites,
                    style: defaultTheme.textTheme.bodyText1,
                    textAlign: TextAlign.justify),
                SizedBox(height: 10),
