    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              Text(_aboutPageText['aboutPageExplanationHeadline'], style: defaultTheme.textTheme.headline4),
              SizedBox(height: 20),
              Text(_aboutPageText['aboutPageExplanation'], style: defaultTheme.textTheme.bodyText1, textAlign: TextAlign.justify),
              SizedBox(height: 10),
              ListTile(
                dense: true,
                leading: Icon(Icons.home, color: Colors.black),
                title: Text(_aboutPageText['aboutPageAvailabilities'][0], style: defaultTheme.textTheme.bodyText1),
              ),
              ListTile(
                dense: true,
                leading: Icon(Icons.local_shipping, color: Colors.black),
                title: Text(_aboutPageText['aboutPageAvailabilities'][1], style: defaultTheme.textTheme.bodyText1),
              ),
              ListTile(
                dense: true,
                leading: Icon(Icons.directions_boat, color: Colors.black),
                title: Text(_aboutPageText['aboutPageAvailabilities'][2], style: defaultTheme.textTheme.bodyText1),
              ),
              ListTile(
                dense: true,
                leading: Icon(Icons.airplanemode_active, color: Colors.black),
                title: Text(_aboutPageText['aboutPageAvailabilities'][3], style: defaultTheme.textTheme.bodyText1),
              ),
              SizedBox(height: 10),
              Text(_aboutPageText['aboutPageColors'], style: defaultTheme.textTheme.bodyText1, textAlign: TextAlign.justify),
              SizedBox(height: 10),
              Text(_aboutPageText['aboutPageFavorites'], style: defaultTheme.textTheme.bodyText1, textAlign: TextAlign.justify),
              SizedBox(height: 10),
